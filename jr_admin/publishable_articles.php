...
if (isset($_SESSION['admin'])) {
    $obj_admin = new Admin();
    $result = $obj_admin->publishable_articles();
...
foreach ($result as $res) {
    ...
    <?php echo $res['user_email'] . "<br/>"; ?>
                                    ...
                                    <td>
                                      <?php if (isset($res['accepted_date'])){ echo date('d-m-Y', strtotime($res['accepted_date'])); } ?>
...
<!--                                    </td>-->
<!--                                    <td>-->
<!--                                        <a href="review_files/--><?php //echo $res['acceptance_letter']; ?><!--" download>--><?php //echo $res['acceptance_letter']; ?><!--</a>-->
<!--                                     -->
<!--                                        -->
<!--                                    </td>-->
                                    <td>
                                       <a href="publishable_article_details.php?journal_id=<?php echo $res['journal_id']; ?>" class="btn btn-primary btn-xs">Add Details</a> 
                                    </td>
