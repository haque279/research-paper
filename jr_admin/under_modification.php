...
<?php
    ...
    if(isset($_SESSION['admin'])){
        $obj_admin = new Admin();
        $result = $obj_admin->under_modification_articles();
                                ...
                                foreach($result as $res){
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="journal_details.php?journal_id=<?php echo $res['journal_id']; ?>&journal_no=<?php echo $i ; ?>"><?php echo $res['journal_title']; ?></a></td>
                                        ...
                                        <td><a href="add_modification.php?journal_id=<?php echo $res['journal_id']; ?>" class="btn btn-primary btn-xs">Add Modification info</a></td>
